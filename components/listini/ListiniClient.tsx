...
interface Props {
  initialCategorie: CategoriaConListini[]
}

export default function ListiniClient({ initialCategorie }: Props) {
  const router = useRouter()
  // Dati già disponibili al primo render grazie all'SSR
  const [categorie, setCategorie] = useState<CategoriaConListini[]>(initialCategorie)
  ...
  // Sincronizza se le prop cambiano (navigazione client-side)
  useEffect(() => {
