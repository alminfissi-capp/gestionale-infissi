...
/* ------------------------------------------------------------------ *
 * Attivita' dentro la commessa                                       *
 * ------------------------------------------------------------------ */

/**
 * Le attivita' di una commessa, in ordine di calendario. Sono le stesse righe
 * che si vedono sul Gantt: programmarne una qui o la' e' lo stesso gesto.
